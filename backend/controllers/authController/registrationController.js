...
import { sendMail, signupTemplate } from "../../utils/sendgrid.js";
...
export const handleFirstRegistrationProcess = async (req, res) => {
...
export const handleSecondRegistrationProcess = async (req, res) => {
  const schema = Joi.object({
    email: Joi.string().required(),
...
export const handleUserActivation = async (req, res) => {
